  ...
  try {
    ...
    if (action === 'capture') {
      ...
      if (captureResult.status === 'COMPLETED') {
        ...
        const redirectUrl = `${url.origin.replace('njvqehuhhrgabuofnbup.supabase.co/functions/v1', 'c7315b1a-bd1e-43c7-828d-f0b066b72a1c.lovableproject.com')}/dashboard?payment=success`;
    ...
    if (action === 'cancel') {
      const redirectUrl = `${url.origin.replace('njvqehuhhrgabuofnbup.supabase.co/functions/v1', 'c7315b1a-bd1e-43c7-828d-f0b066b72a1c.lovableproject.com')}/dashboard?payment=cancelled`;
